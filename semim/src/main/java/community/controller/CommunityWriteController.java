...
//		CommunityInsertDto dto = new CommunityInsertDto(communityName, communityContent, gamerInfoDto.getGamerId(),fileList);
		CommunityInsertDto dto = new CommunityInsertDto(communityName, communityContent, "qw", fileList);  //TODO

 ...
 * Generated at: 2024-03-25 05:08:24 UTC
...
public final class checkall4_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		var $checkedElement = $(this);\r\n");
      out.write("		//checkedElement.innerHTML = '';\r\n");
      out.write("		//$를 넣으면 jQury형태의 this가 들어있구나라고 확인가능 \r\n");
      out.write("		//$checkedElement.html('');\r\n");
      out.write("		\r\n");
      out.write("		$(\".checkedItems\").children().each(function(index, element){\r\n");
      out.write("			console.log(\"this와 element 같음\");\r\n");
      out.write("			console.log($(this).data(\"itemcode\"));\r\n");
      out.write("			console.log($checkedElement.data(\"itemcode\"));\r\n");
      out.write("			if($(this).data(\"itemcode\") == $checkedElement.data(\"itemcode\")){\r\n");
      out.write("				$(this).remove();\r\n");
      out.write("				// for 문은 아니므로 break; 사용 불가.\r\n");
      out.write("				return; \r\n");
      out.write("			}			\r\n");
      out.write("		});\r\n");
      out.write("	}\r\n");
      ...
      out.write("		//$(\".checkedItems\").html(\"\");\r\n");
      out.write("		$(\".item\").each(function() {\r\n");
      out.write("			// $(\".checkedItems\").children().each(function(){\r\n");
      out.write("			//});\r\n");
      out.write("			console.log(\"=====\");\r\n");
      out.write("			var temp = \".checkedItems > div[data-itemcode=\"+$(this).data(\"itemcode\")+\"]\";\r\n");
      out.write("			console.log($(temp).length);\r\n");
      out.write("			if( !$(temp).length ){\r\n");
      out.write("				var label = $(this).parent().children(\"label\").html();\r\n");
      out.write("				var htmlVal = '';\r\n");
      out.write("				htmlVal +='<div data-itemcode=\"'+$(this).data(\"itemcode\")+'\">';\r\n");
      out.write("				htmlVal +='	<span>'+label+'</span>';\r\n");
